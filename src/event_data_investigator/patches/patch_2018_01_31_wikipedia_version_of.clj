(ns event-data-investigator.patches.patch-2018-01-31-wikipedia-version-of
  "Remove all of the is_version_of Wikipedia Events as they don't fit the new model."
...
(defn run
  ...
  (let [jwt (bus/build-jwt "wikipedia")
        events (query/fetch-query-api "/v1/events" {:source "wikipedia" :relation-type "is_version_of"} :events)
